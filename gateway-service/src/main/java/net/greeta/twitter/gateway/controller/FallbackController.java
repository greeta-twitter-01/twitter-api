package net.greeta.twitter.gateway.controller;

import net.greeta.twitter.gateway.model.AnalyticsDataFallbackModel;
import net.greeta.twitter.gateway.model.QueryServiceFallbackModel;
