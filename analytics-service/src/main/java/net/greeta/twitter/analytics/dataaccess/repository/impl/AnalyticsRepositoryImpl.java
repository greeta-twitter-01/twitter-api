package net.greeta.twitter.analytics.dataaccess.repository.impl;

import net.greeta.twitter.analytics.dataaccess.entity.BaseEntity;
import net.greeta.twitter.analytics.dataaccess.repository.AnalyticsCustomRepository;
