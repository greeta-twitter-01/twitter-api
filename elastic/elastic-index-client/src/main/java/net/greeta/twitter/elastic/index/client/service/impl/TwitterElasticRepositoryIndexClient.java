package net.greeta.twitter.elastic.index.client.service.impl;

import net.greeta.twitter.elastic.index.client.repository.TwitterElasticsearchIndexRepository;
